...
exports.DateTimePickerModal = function (props) {
    ...
    return (React.createElement(BasePicker_1.default, __assign({}, props), function (_a) {
        ...
        return (React.createElement(ModalWrapper_1.default, __assign({ ref: forwardedRef, disableFuture: disableFuture, disablePast: disablePast, maxDate: maxDate, minDate: minDate, onAccept: handleAccept, onChange: handleTextFieldChange, onClear: handleClear, onDismiss: handleDismiss, onSetToday: handleSetTodayDate, value: value, isAccepted: isAccepted, format: pick12hOr24hFormat(utils.dateTime12hFormat, utils.dateTime24hFormat) }, other),
