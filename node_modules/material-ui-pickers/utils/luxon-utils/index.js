...
var LuxonUtils = /** @class */ (function () {
    function LuxonUtils(_a) {
        ...
        this.parse = luxon_1.DateTime.fromFormat;
    ...
    LuxonUtils.prototype.date = function (value) {
        ...
        if (typeof value === 'string') {
            return luxon_1.DateTime.fromJSDate(new Date(value));
        }
    ...
    LuxonUtils.prototype.getDiff = function (value, comparing) {
        if (typeof comparing === 'string') {
            comparing = luxon_1.DateTime.fromJSDate(new Date(comparing));
        }
    ...
    LuxonUtils.prototype.getWeekdays = function () {
        return luxon_1.Info.weekdaysFormat('narrow', { locale: this.locale });
    };
    ...
    LuxonUtils.prototype.getMeridiemText = function (ampm) {
        return luxon_1.Info.meridiems({ locale: this.locale }).find(function (v) { return v.toLowerCase() === ampm.toLowerCase(); });
    };
