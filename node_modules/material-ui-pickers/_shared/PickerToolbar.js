...
var PickerToolbar = function (_a) {
    ...
    return (React.createElement(Toolbar_1.default, __assign({ className: classnames_1.default(classes.toolbar, className) }, other), children));
};
...
exports.default = withStyles_1.default(styles, { name: 'MuiPickersToolbar' })(PickerToolbar);
